...
async function page() {
    ...
    return (
        <main className='flex flex-col min-h-screen'>
            ...
            <section className='relative bg-violet-900 text-white overflow-hidden py-24 sm:py-32'>
                ...
                <div className='relative container mx-auto px-4 flex flex-col items-center text-center space-y-8'>
                    ...
                    <div className="inline-flex items-center rounded-full border border-violet-400/30 bg-violet-400/10 px-3 py-1 text-sm font-medium text-violet-300 ring-1 ring-inset ring-violet-400/20">
                    ...
                    <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl max-w-4xl leading-tight">
                        ...
                        <span className="text-violet-400">Restocking Your Fridge</span>
                    </h1>
            ...
            <section className='py-16 bg-white'>
                <div className='container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8'>
                    ...
                    <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-violet-50/50">
            ...
            <section className='py-20 bg-gray-50'>
                <div className='container mx-auto px-4 space-y-12'>
                    <div className="flex justify-between items-end">
                        ...
                        <Link href="/products" className="text-violet-600 font-semibold hover:text-violet-700 hover:underline flex items-center">
                                ...
                                <div key={product.id} className="group flex flex-col bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <div className="p-4 flex-1 flex flex-col">
                                        ...
                                        <div className="flex flex-col items-center justify-between mt-auto">
                                            <span className="font-bold text-lg text-violet-900">
                                                ${Number(product.price).toFixed(2)}
                                            </span>
                                            <Button variant="secondary" className="bg-violet-50 text-violet-700 hover:bg-violet-100 w-full p-2">
                                                Add To Cart
                                            </Button>
                                        </div>
                                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        ...
                        <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-0.5 bg-gradient-to-r from-violet-200 via-violet-400 to-violet-200 -z-10"></div>

                        <div className="flex flex-col items-center text-center bg-white">
                            <div className="h-24 w-24 bg-violet-100 rounded-full flex items-center justify-center mb-6 shadow-md border-4 border-white">
            ...
            <section className="py-24 bg-violet-900 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative flex flex-col items-center text-center space-y-8">
                    ...
                    <p className="text-violet-100 max-w-xl text-lg">Get exclusive offers, healthy recipes, and budget-saving tips delivered straight to your inbox.</p>
                    <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                        <input
                            type="email"
                            placeholder="Enter your email address"
                            className="flex-1 border-white border rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-400"
                        />
                        <Button size="lg" className="bg-violet-500 hover:bg-violet-400 text-white font-semibold whitespace-nowrap px-8">
                            Subscribe
                        </Button>
                    </div>
                    <p className="text-xs text-violet-200/60 mt-4">We respect your privacy. Unsubscribe at any time.</p>
                </div>
            </section>
        </main>
    )
