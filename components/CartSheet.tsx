        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetTrigger >
                <Button variant="ghost" size="icon" className="relative">
                    ...
                    {itemCount > 0 && (
                        <span className="absolute -top-1 -right-4 h-4 w-4 bg-violet-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center pointer-events-none">
                            {itemCount}
                        </span>
                    )}
                </Button>
                ...
                {cart && cart.items.length > 0 && (
                    <SheetFooter className="border-t pt-6 sm:justify-center">
                        <div className="w-full space-y-4">
                            ...
                            <Button
                                className="w-full bg-violet-600 hover:bg-violet-700 text-black h-12 text-lg"
